                ...
                <div class="rounded-lg bg-white p-6 shadow-md">
                    ...
                    <form action="{{ $url }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="guard_name" id="guard_name" class="form-textarea w-full" rows="1">{{ @$role->guard_name }}</textarea>
                            @error('guard_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="flex justify-end">
                            <button class="rounded bg-green-700 px-4 py-2 font-bold text-white hover:bg-blue-700"
                                type="submit">
                        ...
                        <tbody>
                            @foreach ($roles as $item)
                                <tr class="capitalize">
                                    ...
                                    <td class="text-right">
                                        <a href="{{ url('admin/role/edit/' . $item->id) }}">
                                            <button
